...
such, will defer implementing stylistic rules that are obviated by autoformatting.
...
## Do I have to Ruff's linter and formatter together?

Nope! The Ruff Linter and Ruff Formatter can be used independently of one another -- you can use
...
directories, and lint them accordingly. Formatter support is not yet available for Jupyter
Notebooks.
